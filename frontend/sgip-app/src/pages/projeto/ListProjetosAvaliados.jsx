...
const ListProjetosAvaliados = () => {
  ...
  const projetosAvaliados = projetos.filter((projeto) => projeto.status !== "Não Avaliado");
      ...
      <table className="table">
        ...
        <tbody>
          {projetosAvaliados.length === 0 ? (
            <tr>
              <td colSpan="12">Sem projetos Avaliados</td>
            </tr>
          ) : (
...
export default ListProjetosAvaliados;
