...
const ListProjetosNaoAvaliados = () => {
  ...
  // Filtrar projetos avaliados
  const projetosAvaliados = projetos.filter((projeto) => projeto.status !== "Avaliado");
      ...
      <table className="table">
        ...
        <tbody>
          {projetosAvaliados.length === 0 ? (
            <tr>
              <td colSpan="8">Todos os Projetos Foram Avaliados</td>
            </tr>
          ) : (
...
export default ListProjetosNaoAvaliados;
